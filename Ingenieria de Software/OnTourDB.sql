...
CREATE TABLE info_actividad (
    cant_actividad          [int] NOT NULL,
    contrato_numcontrato    [int] NOT NULL,
    actividad_idactividad   [int] NOT NULL
);

ALTER TABLE info_actividad ADD CONSTRAINT info_actividad_pk PRIMARY KEY ( contrato_numcontrato,
                                                                          actividad_idactividad );

CREATE TABLE info_beneficio (
    cant_beneficio         [int] NOT NULL,
    contrato_numcontrato   [int] NOT NULL,
    beneficio_idbenefico   [int] NOT NULL
);

ALTER TABLE info_beneficio ADD CONSTRAINT info_beneficio_pk PRIMARY KEY ( contrato_numcontrato,
                                                                          beneficio_idbenefico );

CREATE TABLE info_seguro (
    cant_seguros           [int] NOT NULL,
    contrato_numcontrato   [int] NOT NULL,
    seguro_idseguro        [int] NOT NULL
);

ALTER TABLE info_seguro ADD CONSTRAINT info_seguro_pk PRIMARY KEY ( contrato_numcontrato,
                                                                    seguro_idseguro );
...
ALTER TABLE info_actividad
    ADD CONSTRAINT info_actividad_actividad_fk FOREIGN KEY ( actividad_idactividad )
        REFERENCES actividad ( idactividad );

ALTER TABLE info_actividad
    ADD CONSTRAINT info_actividad_contrato_fk FOREIGN KEY ( contrato_numcontrato )
        REFERENCES contrato ( numcontrato );

ALTER TABLE info_beneficio
    ADD CONSTRAINT info_beneficio_beneficio_fk FOREIGN KEY ( beneficio_idbenefico )
        REFERENCES beneficio ( idbenefico );

ALTER TABLE info_beneficio
    ADD CONSTRAINT info_beneficio_contrato_fk FOREIGN KEY ( contrato_numcontrato )
        REFERENCES contrato ( numcontrato );

ALTER TABLE info_seguro
    ADD CONSTRAINT info_seguro_contrato_fk FOREIGN KEY ( contrato_numcontrato )
        REFERENCES contrato ( numcontrato );

ALTER TABLE info_seguro
    ADD CONSTRAINT info_seguro_seguro_fk FOREIGN KEY ( seguro_idseguro )
        REFERENCES seguro ( idseguro );